...
namespace Hybrid\Cache\Limiters;

use Hybrid\Tools\Sleep;
...
class ConcurrencyLimiter {
     ...
     *
     * @var \Hybrid\Cache\Contracts\LockProvider
     */
    protected $store;
     ...
     *
     * @param \Hybrid\Cache\Contracts\LockProvider $store
     * @param string                               $name
     * @param int                                  $maxLocks
     ...
     * @return mixed
     *
     * @throws \Hybrid\Cache\Limiters\LimiterTimeoutException
     * @throws \Throwable
     */
     ...
     * @param string $id
     *
     * @return \Hybrid\Cache\Contracts\Lock|false
     */
     ...
     * Release the lock.
     *
     * @param \Hybrid\Cache\Contracts\Lock $lock
     *
     * @return void
     */
