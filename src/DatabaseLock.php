...
use Hybrid\Database\Connection;
use Hybrid\Database\DetectsConcurrencyErrors;
...
class DatabaseLock extends Lock {
     ...
     *
     * @var \Hybrid\Database\Connection
     */
     ...
     *
     * @param \Hybrid\Database\Connection $connection
     * @param string                      $table
     * @param string                      $name
     * @param int                         $seconds
    ...
    protected function expiresAt() {
        $lockTimeout = 0 < $this->seconds ? $this->seconds : $this->defaultTimeoutInSeconds;
