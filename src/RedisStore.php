...
use Hybrid\Redis\Connections\PhpRedisClusterConnection;
use Hybrid\Redis\Connections\PhpRedisConnection;
use Hybrid\Redis\Connections\PredisClusterConnection;
use Hybrid\Redis\Connections\PredisConnection;
use Hybrid\Redis\Contracts\Factory as Redis;
...
class RedisStore extends TaggableStore implements LockProvider {
     ...
     *
     * @var \Hybrid\Redis\Contracts\Factory
     */
    protected $redis;
     ...
     *
     * @param \Hybrid\Redis\Contracts\Factory $redis
     * @param string                          $prefix
     ...
     * @param mixed $names
     *
     * @return \Hybrid\Cache\RedisTaggedCache
     */
     ...
     *
     * @return \Hybrid\Redis\Connections\Connection
     */
     ...
     *
     * @return \Hybrid\Redis\Contracts\Factory
     */
     ...
     *
     * @param mixed                                $value
     * @param \Hybrid\Redis\Connections\Connection $connection
     *
     * @return mixed
     */
